      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-10">
            <h5 className='bg-primary p-3 text-light text-center rounded'>Maincategory<Link to="/admin-add-maincategory"><i className='fa fa-plus text-light float-right'></i></Link></h5>
                  ...
                  </tr>
                  {
                    data.map((item, index) => {
                      return <tr key={index}>
                        <td>{item.id}</td>
                        <td>{item.name}</td>
                        <td><Link to={"/admin-update-maincaregory/" + item.id}><i className='fa fa-edit'></i></Link></td>
